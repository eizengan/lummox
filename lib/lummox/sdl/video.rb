...
module Lummox::SDL::Video
  ...
  WINDOW_FLAGS = {
    ...
    WINDOW_FULLSCREEN_DESKTOP: 0x00000001 | 0x00001000,
  ...
  def self.included(base)
    base.class_eval do
      ...
      attach_sdl_function :get_display_bounds, [:int, Lummox::SDL::Geometry::Rect.by_ref], :int # negative if error
      attach_sdl_function :get_display_usable_bounds, [:int, Lummox::SDL::Geometry::Rect.by_ref], :int # negative if error
      # Display modes
