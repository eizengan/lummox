...
module Lummox::SDL::Joystick
  HAT = {
    ...
    HAT_DOWN: 0x04,
    HAT_LEFT: 0x08,
    HAT_RIGHT_UP: (0x02 | 0x01),
    HAT_RIGHT_DOWN: (0x02 | 0x04),
    HAT_LEFT_UP: (0x08 | 0x01),
    HAT_LEFT_DOWN: (0x08 | 0x04)
  }.freeze
  ...
  def self.included(base)
    base.class_eval do
      ...
      attach_sdl_function :joystick_get_button, %i[joystick_pointer int], Lummox::SDL::ButtonState
