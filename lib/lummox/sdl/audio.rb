...
module Lummox::SDL::Audio
  ...
  def self.included(base)
    base.class_eval do
      ...
      attach_sdl_function :load_wav_rw, [Lummox::SDL::IO::RWOps.by_ref, :bool, AudioSpec.by_ref, :pointer, :uint32_pointer], :void, sdl_method_name: :SDL_LoadWAV_RW # null if error
    end
  end
